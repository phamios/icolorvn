<div class="box grid_4">
    ...
    <div class="box-content ">
        ...
        <?php echo form_open_multipart('admincp/menutop/'.$row->menuid); ?>
    ...
    <div class="box-content ">
        ...
        <?php echo form_open_multipart('admincp/menutop'); ?>
                ...
                <?php if ($allmenu_foot <> NULL): ?>
                    <?php foreach ($allmenu_foot as $row): ?>	 
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="<?php echo site_url('admincp/menutop/' . $row->menuid); ?>"><img src="<?php echo base_url('themes/huyxom/admin/appstore/img/icons/basic/save.png'); ?>" alt="" /> Sửa </a>
                                <a href="<?php echo site_url('admincp/del_menutop/' . $row->menuid); ?>"><img src="<?php echo base_url('themes/huyxom/admin/appstore/img/icons/basic/delete.png'); ?>" alt="" /> Xóa </a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
