                ...
                <?php if ($allmenu_foot <> NULL): ?>
                    <?php foreach ($allmenu_foot as $row): ?>	 
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="<?php echo site_url('admincp/menutop/' . $row->menuid); ?>"><i class="icon-edit bigger-120"></i></a>
                                <a href="<?php echo site_url('admincp/del_menutop/' . $row->menuid); ?>"><i class="icon-trash bigger-120"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
