	...
	for ($i = 1; $i <= $roomcount; $i++)
	{
		...
		for ($ii = 1; $ii <= $days; $ii++)
		{
			...
			else
			{
				...
				{
					$fc = 3;
					if ( $booking[ $i ][0][0] == 267)
						$fc = 0 ;
					if ( $booking[ $i ][0][0] == 366)
						$fc = 0 ;
					if ( $booking[ $i ][0][0] == 466)
						$fc = 0 ;
					if ( $booking[ $i ][0][0] == 467)
						$fc = 0 ;
					if ( $booking[ $i ][0][0] == 566)
						$fc = 0 ;
					if ( $booking[ $i ][0][0] == 567)
						$fc = 0 ;
					if ( $booking[ $i ][0][0] == 268)
						$fc = 1 ;
					if ( $booking[ $i ][0][0] == 368)
						$fc = 1 ;
					if ( $booking[ $i ][0][0] == 468)
						$fc = 1 ;
					if ( $booking[ $i ][0][0] == 568)
						$fc = 1 ;
